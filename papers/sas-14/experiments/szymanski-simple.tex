...
%
%
The full version of Szymanski's protocol~\cite{Szymanski:protocol} is
shown in Section~\ref{section:paramsys}. We present here a compact
version taken from~\cite{APRXZ01}.
