...
\node[rounded corners,draw = cyan,name=cell1,minimum width=24pt, minimum height=20pt]{};
...
\node[draw = blue!50,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell1.north){\cross};
...
blue!50
\node[rounded corners,draw = cyan,name=cell2,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = blue!50,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell2.north){\cross};
\node[draw=cyan,minimum width=8pt, minimum height=10pt,anchor=south,font=\tiny,inner sep=0pt]at (cell2.south){\tick};
...
\node[rounded corners,draw = cyan,name=cell3,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = blue!50,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell3.north){\cross};
\node[draw = cyan,minimum width=8pt, minimum height=10pt,anchor=south,font=\tiny,inner sep=0pt]at (cell3.south){\cross};
...
\node[rounded corners,draw = cyan,name=cell4,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = blue!50,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell4.north){\cross};
\node[draw = cyan,minimum width=8pt, minimum height=10pt,anchor=south,font=\tiny,inner sep=0pt]at (cell4.south){\tick};
...
\node[rounded corners,draw = cyan,name=cell5,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = blue!50,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell5.north){\cross};
\node[draw = cyan,minimum width=8pt, minimum height=10pt,anchor=south,font=\tiny,inner sep=0pt]at (cell5.south){\cross};
...
\node[rounded corners,draw = cyan,name=cell7,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = blue!50,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell7.north){\tick};
\node[draw = cyan,minimum width=8pt, minimum height=10pt,anchor=south,font=\tiny,inner sep=0pt]at (cell7.south){\tick};
