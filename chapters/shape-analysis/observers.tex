...
\bjcom{One possible suggestion for making the section more readable:
  Start by saying that there are several approaces: logical, etc. Write several sentences about each: what is its characteristics, maybe say what it has been
  able to
  Thereafter you can focus on automata-based. But to more slowly. Explain what is the essential ideas, and also what is the problem. You could for instance
