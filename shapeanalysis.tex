...
\input TA
 ...
 \begin{itemize}
 	\item Local data constraints are associated with transitions of TA \bjfix{TA}{each TA} and capture relationships between data of neighboring nodes in a heap graph; they can be used, e.g., to represent ordering internal to some structure \bjcom{Be more specific than ``some structure''} such as a binary search tree.
